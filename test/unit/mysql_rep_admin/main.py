...
class UnitTest(unittest.TestCase):
    ...
    @mock.patch("mysql_rep_admin.gen_libs.help_func")
    @mock.patch("mysql_rep_admin.arg_parser.arg_parse2")
    def test_arg_dir_false(self, mock_arg, mock_help, mock_or, mock_req,
                           mock_cond, mock_dir, mock_file):
    ...
    @mock.patch("mysql_rep_admin.gen_libs.help_func")
    @mock.patch("mysql_rep_admin.arg_parser.arg_parse2")
    def test_arg_file_false(self, mock_arg, mock_help, mock_or, mock_req,
                            mock_cond, mock_dir, mock_file, mock_run):
